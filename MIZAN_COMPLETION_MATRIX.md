...
انحراف (`tests/completion-matrix-truth.test.ts`) يعيد توليده ويقارنه. فلا يُكتب هنا صفٌّ
«جاهز» لا يقابله دليلٌ في الشيفرة: البصمة تُحسب من البايتات، وجسرُ المواضع يُقارن بالعدّ
القانوني سورةً سورة، والحالة تُركَّب منهما.
...
|---|---|---|---|---|---|---|---|---|---|
| قالون عن نافع | KFGQPC delivery mirror | ❌ | — | ⚠️ ترقيم غير مفحوص | ⚠️ يحتاج طبقة التسليم | ✅ | ✅ | حفص | TESTED |
| ورش عن نافع | KFGQPC delivery mirror | ❌ | — | ⚠️ ترقيم غير مفحوص | ⚠️ يحتاج طبقة التسليم | ✅ | ✅ | حفص | TESTED |
| البزي عن ابن كثير | KFGQPC delivery mirror | ❌ | — | ⚠️ ترقيم غير مفحوص | ⚠️ يحتاج طبقة التسليم | ✅ | ✅ | حفص | TESTED |
...
- `RELEASE_READY` — نصٌّ حُمِّل من بايتاتٍ طابقت بصمتها المعتمدة، وجسرُ مواضعه لا يحمل موضعًا
  مجهولًا، فالسحب والسؤال منه صحيحان.
- `TESTED` — المنطق كامل ومُختبَر، والنصّ يُجلب من طبقة تسليم المجمع وقت التشغيل، فلا تُقرأ
  بايتاته داخل هذه الشجرة. وترقيمُ حزمته لم يُفحص هنا، فيبقى التطابق مع العدّ القانوني
  افتراضًا معلَنًا لا نتيجةً متحقّقة — وهو سلوك النظام قبل هذا العمل وبعده.
- `BLOCKED` — نصُّ الرواية حاضرٌ ومُتحقَّقُ البصمة، لكن عدّ آياتها يخالف العدّ القانوني في
  سورٍ لم يصل لها دليلُ جسر. السحب منها ممنوع لأنه يعطي موضعًا لا وجود له في الرواية، لا
  لأن نصّها ناقص.

**الصوت** لجميع الروايات العشرين حفصٌ عن عاصم — قرارُ منتَجٍ مقصود. زرُّ الواجهة «استمع إلى
الآية» بلا وسمٍ للرواية، وهوية الصوت مفصولةٌ عن هوية النصّ في الشيفرة (`global-hafs-audio`)
فلا يُتّخذ صوتُ حفصٍ دليلًا على نصّ روايةٍ أخرى ولا تُبنى عليه مزامنةُ كلمة.
