...
import { reviewReasonLabel, sealFailureLabel, uiToken } from '../../lib/ui-language';
...
import { MutashabihatHint } from './MutashabihatHint';
...
export const HeadJudgeInbox: React.FC = () => {
 ...
 return <div className="max-w-6xl mx-auto px-4 sm:px-6 py-7 space-y-5">
  ...
  {guardianAttention.length>0&&<ScaleTendencyChart rows={guardianAttention} ar={ar} committeeCodeOf={id=>store.committees.find(c=>c.id===id)?.code||''}/>}
