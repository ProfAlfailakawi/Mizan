...
const reasonLabel=(r:string,ar:boolean)=>({judge_variance:ar?'اختلاف المحكمين':'Judge variance',ai_high_confidence_alert:ar?'ملاحظة نزاهة آلية':'AI integrity observation',audio_dropout:ar?'مشكلة صوت':'Audio issue',score_outlier:ar?'تباين درجة':'Score outlier',sealed_result_protection:ar?'حماية نتيجة مختومة':'Sealed result protected',panel_revision_mixed:ar?'اختلاف نسخة المعايير':'Mixed criteria revision'} as Record<string,string>)[r]||r;
