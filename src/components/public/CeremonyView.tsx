 ...
 return <div className="fixed inset-0 z-50 bg-[#101a16] text-white overflow-hidden flex flex-col p-5 sm:p-8">
   ...
   <main className="flex-1 grid place-items-center px-3"><div className="w-full max-w-5xl text-center">
    {!authorized?<div className="max-w-xl mx-auto">
      ...
      {vault&&<div className="mt-5 text-[9px] text-white/30 font-mono">{vault.encryptionAlgorithm||'SEALED'} · {vault.keyManagement==='development_adapter'?(ar?'محوّل تشفير تطويري':'DEVELOPMENT CRYPTO ADAPTER'):(ar?'إدارة مفاتيح خارجية':'EXTERNAL KMS')} · {vault.publicCommitmentHash.slice(0,18)}…</div>}
    </div>
