...
import type {
  Category, Participant, QuestionModelBatchRecord, QuestionPoolItem, QuestionQuarantineRecord, QuestionReservationRecord,
  QuranSourceContentRecord, QuranSourceManifestRecord,
...
export function createScopeEngineActions(host: ScopeEngineHost) {
  ...
  return {
    ...
    scopeCandidatePool, sourceResolvedQuestionPool, categoryPassageAyahRange, poolsForRows, scopeDemandAnalysis, getScopeReadiness, runScopeSimulation, runFairnessOracle,
