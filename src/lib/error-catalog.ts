...
export const ERROR_CATALOG: readonly ErrorDescription[] = [
  ...
  ENTRY('SESSION_START_OUT_OF_TURN', 'RECOVERY', 'هذا المتسابق ليس صاحب الدور في طابور لجنته. يُنادى صاحب الدور، ومن تأخّر أو تعذّر حضوره يُعاد ترتيبه من غرفة العمليات.'),
  ...
  ENTRY('ANNUAL_PARTICIPANT_LIMIT_REACHED', 'CONFIG', 'بلغت الجهة حدَّ المتسابقين السنوي في ترخيصها. يُراجَع الاشتراك قبل فتح تسجيلٍ جديد.'),
  ENTRY('ACTIVE_COMPETITION_LIMIT_REACHED', 'CONFIG', 'بلغت الجهة حدَّ المسابقات النشطة في ترخيصها. تُغلق مسابقةٌ منتهية أو يُوسَّع الاشتراك.'),
  ENTRY('TENANT_SUSPENDED', 'CONFIG', 'اشتراك الجهة موقوف، فالعمليات التجارية متوقفة حتى يُستأنف.'),
