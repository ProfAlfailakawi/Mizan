/*
 * قائمة دول العالم (عربي/إنجليزي) للاستعمال في حقول الجنسية/الدولة مع بحث سريع.
 * القيمة المخزّنة بصيغة ثنائية "English (عربي)" لتتوافق مع localizedCountry في العرض.
 */
export interface CountryOption { code: string; ar: string; en: string; }
...
export const COUNTRIES: CountryOption[] = [
  ...
  { code: 'CD', ar: 'جمهورية الكونغو الديمقراطية', en: 'DR Congo' },
...
/** القيمة المخزّنة ثنائية اللغة لتتوافق مع localizedCountry: "English (عربي)". */
export function countryStoredValue(c: CountryOption): string {
  return `${c.en} (${c.ar})`;
}

/** بحث سريع بالعربية أو الإنجليزية أو رمز الدولة. */
