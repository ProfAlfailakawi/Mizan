...
async function startServer() {
  ...
  app.post('/api/audit/events',requireGovernanceRoles(auditWriterRoles),(req,res)=>{if(!serverAuditLedger)return res.status(503).json({code:'AUDIT_LEDGER_NOT_CONFIGURED'});const actor=(req as any).mizanIdentity as ServerIdentity;const b=req.body||{};
    /*
