...
async function startServer() {
  ...
  const tenantAccessBlocked=(identity:ServerIdentity)=>identity.role!=='super_admin'&&tenantByOrganizationId(identity.organizationId)?.status==='suspended';
