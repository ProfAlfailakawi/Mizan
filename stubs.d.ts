...
declare module 'react' { const React:any; export default React; export const StrictMode:any; export function useState<T=any>(initial?:T|(()=>T)):[T,(value:any)=>void]; export function useEffect(fn:any,deps?:any[]):void; export function useLayoutEffect(fn:any,deps?:any[]):void; export function useMemo<T=any>(fn:()=>T,deps:any[]):T; export function useRef<T=any>(initial?:T):{current:T}; export function useCallback<T extends (...args:any[])=>any>(fn:T,deps:any[]):T; export function useSyncExternalStore<T=any>(subscribe:(fn:()=>void)=>()=>void,getSnapshot:()=>T,getServerSnapshot?:()=>T):T; export const Suspense:any; export function lazy(loader:()=>Promise<any>):any; export type FC<P={}>=any; }
...
declare module '@firebase/rules-unit-testing' { export type RulesTestEnvironment=any; export const initializeTestEnvironment:any; export const assertFails:any; export const assertSucceeds:any; }
